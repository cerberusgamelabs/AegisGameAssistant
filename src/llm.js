 ...
 */
export async function queryLLM(base64Image, userQuery) {
  ...
  switch (config.llm.provider) {
    case 'ollama':
      return queryOllama(base64Image, systemPrompt, userText);
    case 'anthropic':
      return queryAnthropic(base64Image, systemPrompt, userText);
    case 'openai':
      return queryOpenAI(base64Image, systemPrompt, userText);
    default:
      throw new Error(`Unknown LLM provider: "${config.llm.provider}"`);
  }
}

async function queryOllama(base64Image, systemPrompt, userText) {
...
async function queryAnthropic(base64Image, systemPrompt, userText) {
...
async function queryOpenAI(base64Image, systemPrompt, userText) {
